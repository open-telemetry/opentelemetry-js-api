...
describe('TraceState', () => {
  describe('.serialize()', () => {
    ...
    it('must create a createTraceState and move updated keys to the front', () => {
    ...
    it('must create a createTraceState and add new keys to the front', () => {
    ...
    it('must create a createTraceState and unset the entries', () => {
